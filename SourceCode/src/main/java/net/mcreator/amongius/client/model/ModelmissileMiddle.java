...
public class ModelmissileMiddle<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("amongius", "modelmissile_middle"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition thewholething = partdefinition.addOrReplaceChild("thewholething",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -22.35F, -3.0F, 6.0F, 32.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 30).addBox(-5.0F, -1.35F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(32, 20)
						.addBox(-7.0F, 0.65F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 38).addBox(-2.0F, -23.35F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
