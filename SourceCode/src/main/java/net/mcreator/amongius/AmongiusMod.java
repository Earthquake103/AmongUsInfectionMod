...
import net.mcreator.amongius.init.AmongiusModTabs;
import net.mcreator.amongius.init.AmongiusModSounds;
import net.mcreator.amongius.init.AmongiusModPaintings;
...
import net.mcreator.amongius.init.AmongiusModBlockEntities;
...
@Mod("amongius")
public class AmongiusMod {
	public static final Logger LOGGER = LogManager.getLogger(AmongiusMod.class);
	public static final String MODID = "amongius";
	...
	public AmongiusMod() {
		...
		AmongiusModSounds.REGISTRY.register(bus);
		AmongiusModBlocks.REGISTRY.register(bus);
		AmongiusModBlockEntities.REGISTRY.register(bus);
		AmongiusModItems.REGISTRY.register(bus);
		AmongiusModEntities.REGISTRY.register(bus);

		AmongiusModTabs.REGISTRY.register(bus);

		AmongiusModPaintings.REGISTRY.register(bus);

		AmongiusModMenus.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									AmongiusMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			AmongiusMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
